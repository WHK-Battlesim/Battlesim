...
{
    half3 normal = (input[0].normal + input[1].normal + input[2].normal) * 3;
    
    outStream.Append(VertexOutput(input[0].position.xyz, normal, input[0].tangent, input[0].texcoord));
    outStream.Append(VertexOutput(input[1].position.xyz, normal, input[0].tangent, input[0].texcoord));
    outStream.Append(VertexOutput(input[2].position.xyz, normal, input[0].tangent, input[0].texcoord));
